...
describe('form control focusReducer', () => {
  ...
  it('should update state if unfocused', () => {
    const resultState = focusReducer(INITIAL_STATE, FocusAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should not update state if focused', () => {
    ...
    const resultState = focusReducer(state, FocusAction({controlId: FORM_CONTROL_ID}));
