...
describe(`form group ${markAsTouchedReducer.name}`, () => {
  ...
  it('should mark itself and all children recursively as touched', () => {
    const resultState = markAsTouchedReducer(INITIAL_STATE_FULL, MarkAsTouchedAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should not update state if all children are marked as touched recursively', () => {
    const resultState = markAsTouchedReducer(INITIAL_STATE_FULL_TOUCHED, MarkAsTouchedAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should forward actions to children', () => {
    const resultState = markAsTouchedReducer(INITIAL_STATE, MarkAsTouchedAction({controlId: INITIAL_STATE.controls.inner.id}));
