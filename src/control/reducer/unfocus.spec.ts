...
describe('form control unfocusReducer', () => {
  ...
  it('should update state if focused', () => {
    ...
    const resultState = unfocusReducer(state, UnfocusAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should not update state if unfocused', () => {
    const resultState = unfocusReducer(INITIAL_STATE, UnfocusAction({controlId: FORM_CONTROL_ID}));
