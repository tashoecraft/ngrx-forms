...
describe(`form group ${clearAsyncErrorReducer.name}`, () => {
  ...
  it('should remove error from state', () => {
    ...
    const resultState = clearAsyncErrorReducer(state, ClearAsyncErrorAction({controlId: FORM_CONTROL_ID, name}));
  ...
  it('should track child errors and own errors when own errors are changed', () => {
    ...
    const resultState = clearAsyncErrorReducer(state, ClearAsyncErrorAction({controlId: FORM_CONTROL_ID, name: name1}));
  ...
  it('should track own errors and child errors when child errors are changed', () => {
    ...
    const resultState = clearAsyncErrorReducer(state, ClearAsyncErrorAction({controlId: FORM_CONTROL_ID, name: name2}));
