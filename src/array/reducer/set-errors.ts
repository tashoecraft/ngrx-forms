import { computeArrayState, ValidationErrors } from '../../state';
...
const reducer = createReducer(
    {},
    on(NgrxActions.SetErrorsAction, (state: any, action: any) => {
...
export function setErrorsReducer(state: any | undefined, action: Action) {
