...
describe(`form array ${setAsyncErrorReducer.name}`, () => {
  ...
  it('should aggregate child errors', () => {
    ...
    const resultState = setAsyncErrorReducer(state, SetAsyncErrorAction({controlId: FORM_CONTROL_0_ID, name, value}));
  ...
  it('should aggregate multiple child errors', () => {
    ...
    let resultState = setAsyncErrorReducer(state, SetAsyncErrorAction({controlId: FORM_CONTROL_0_ID, name: name1, value: value1}));
    resultState = setAsyncErrorReducer(resultState, SetAsyncErrorAction({controlId: FORM_CONTROL_1_ID, name: name2, value: value2}));
  ...
  it('should track own errors and child errors when child errors are changed', () => {
    ...
    const resultState = setAsyncErrorReducer(state, SetAsyncErrorAction({controlId: FORM_CONTROL_0_ID, name: name2, value: value2}));
    expect(resultState.errors).toEqual({ [`$${name1}`]: value1, _0: { [`$${name2}`]: value2 } });
  });
