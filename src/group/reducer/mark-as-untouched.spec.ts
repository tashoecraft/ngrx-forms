...
describe(`form group ${markAsUntouchedReducer.name}`, () => {
  it('should update state if touched', () => {
    ...
    const resultState = markAsUntouchedReducer(state, MarkAsUntouchedAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should not update state if untouched', () => {
    const resultState = markAsUntouchedReducer(INITIAL_STATE, MarkAsUntouchedAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should forward actions to children', () => {
    ...
    const resultState = markAsUntouchedReducer(state, MarkAsUntouchedAction({controlId: state.controls.inner.id}));
