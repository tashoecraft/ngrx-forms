...
describe(`form group ${setUserDefinedPropertyReducer.name}`, () => {
  ...
  it('should update state user defined properties if different', () => {
    const prop = 'prop';
    const value = 12;
    const resultState = setUserDefinedPropertyReducer(INITIAL_STATE, SetUserDefinedPropertyAction({controlId: FORM_CONTROL_ID, name: prop, value}));
  ...
  it('should not update state user defined properties if same', () => {
    ...
    const resultState = setUserDefinedPropertyReducer(state, SetUserDefinedPropertyAction({controlId: FORM_CONTROL_ID, name: prop, value}));
  ...
  it('should update state user defined properties for children', () => {
    const prop = 'prop';
    const value = 12;
    const resultState = setUserDefinedPropertyReducer(INITIAL_STATE, SetUserDefinedPropertyAction({controlId: FORM_CONTROL_INNER_ID, name: prop, value}));
