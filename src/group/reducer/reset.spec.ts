...
describe(`form group ${resetReducer.name}`, () => {
  it('should update state if dirty', () => {
    ...
    const resultState = resetReducer(state, ResetAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should not update state if pristine and untouched and unsubmitted', () => {
    const resultState = resetReducer(INITIAL_STATE, ResetAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should forward actions to children', () => {
    ...
    const resultState = resetReducer(state, ResetAction({controlId: state.controls.inner.id}));
