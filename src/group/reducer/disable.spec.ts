...
describe(`form group ${disableReducer.name}`, () => {
  ...
  it('should disable group children', () => {
    const resultState = disableReducer(INITIAL_STATE_FULL, DisableAction({controlId: FORM_CONTROL_ID}));
  ...
  it('should forward actions to children', () => {
    const resultState = disableReducer(INITIAL_STATE, DisableAction({controlId: INITIAL_STATE.controls.inner.id}));
